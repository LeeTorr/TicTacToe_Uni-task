...
class GameActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun initializeGame() {
        val nameOne : String? = intent.getStringExtra(ChooseNameActivity.player_name_one)
        val nameTwo : String? = intent.getStringExtra(ChooseNameActivity.player_name_two)
